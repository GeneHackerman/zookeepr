...
const getAnimals = (formData = {}) => {
  ...
  // this will fetch a queryURL and will return data upon response.ok
  // if not response.ok, error message will display
  // printResults will generate cards with animal array data
  fetch(queryUrl)
    .then(response => {
      if(!response.ok) {
